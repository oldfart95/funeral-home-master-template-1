...
const $$VeteranCremationEs = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$VeteranCremationEs;
  ...
  function generateServiceSchema() {
    ...
    const schema = {
      ...
      "@type": "Service",
      name: "Servicios de Cremaci\xF3n para Veteranos",
      description: "Servicios de cremaci\xF3n para veteranos que reconocen y honran el servicio militar. Le ayudamos a acceder a los beneficios para veteranos y nos aseguramos de que su servicio sea recordado con dignidad.",
      provider: {
        "@type": "FuneralHome",
