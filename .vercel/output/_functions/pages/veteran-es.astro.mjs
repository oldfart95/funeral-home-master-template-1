...
const $$VeteranEs = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$VeteranEs;
...
</p> </div> </section> ${renderComponent($$result2, "OurStory", $$OurStory, { "language": isSpanish ? "es" : "en" })} ${renderComponent($$result2, "ImmediateNeedBanner", $$ImmediateNeedBanner, { "language": isSpanish ? "es" : "en" })} ${renderComponent($$result2, "ServiceButtons", $$ServiceButtons, {})}  <section class="py-10 md:py-24 bg-white"> <div class="container mx-auto px-4 sm:px-6 lg:px-8"> <div class="max-w-4xl mx-auto"> <h2 class="text-2xl md:text-4xl font-heading font-bold text-primary mb-6 md:mb-8 text-center">
Servicios para Veteranos
</h2> <div class="bg-secondary p-5 md:p-8 rounded-lg shadow-sm"> <p class="text-sm md:text-base text-text leading-relaxed mb-6"> <!-- Content will be provided -->
...
1. La Opción Simple<br> <span class="text-base md:text-lg font-normal">(Cremación Directa)</span> </h3> </div> <p class="text-sm md:text-base text-text mb-4 md:mb-6 leading-relaxed">
...
2. La Opción Conmemorativa<br> <span class="text-base md:text-lg font-normal">(Viaje del Recuerdo)</span> </h3> </div> <p class="text-sm md:text-base text-text mb-4 md:mb-6 leading-relaxed">
...
3. La Opción de Servicio Completo<br> <span class="text-base md:text-lg font-normal">(Viaje de la Vida)</span> </h3> </div> <p class="text-sm md:text-base text-text mb-4 md:mb-6 leading-relaxed">
Esto es como un funeral tradicional, pero termina con cremación en lugar de entierro.
</p> <ul class="space-y-2 md:space-y-3 text-sm md:text-base text-text"> <li class="flex items-start"> <span class="text-accent mr-2">•</span> <span>Su cuerpo está preparado para que familiares y amigos puedan visitar y despedirse.</span> </li> <li class="flex items-start"> <span class="text-accent mr-2">•</span> <span>Se usa un "ataúd de alquiler" especial para el servicio.</span> </li> <li class="flex items-start"> <span class="text-accent mr-2">•</span> <span>Después de que termine el servicio funerario, tiene lugar la cremación.</span> </li> </ul> </div> </div> </div> </div> </section>  <section class="py-10 md:py-24 bg-secondary"> <div class="container mx-auto px-4 sm:px-6 lg:px-8"> <div class="max-w-7xl mx-auto"> <h2 class="text-2xl md:text-4xl font-heading font-bold text-primary mb-3 md:mb-4 text-center">
...
</h3> ${renderComponent($$result2, "Accordion", $$Accordion, { "language": "es", "items": getFAQs("es", "veteran") })} </div> </div> </div> </section> ${renderComponent($$result2, "OngoingCare", $$OngoingCare, { "language": isSpanish ? "es" : "en" })} ${renderComponent($$result2, "ContactForm", $$ContactForm, { "language": isSpanish ? "es" : "en" })} ` })}`;
}, "C:/Users/User A/Documents/GitHub/funeral-home-landing-site/src/pages/veteran-es.astro", void 0);

const $$file = "C:/Users/User A/Documents/GitHub/funeral-home-landing-site/src/pages/veteran-es.astro";
const $$url = "/veteran-es";
