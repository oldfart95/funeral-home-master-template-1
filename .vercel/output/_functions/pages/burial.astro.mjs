...
const $$Burial = createComponent(($$result, $$props, $$slots) => {
  ...
  function generateServiceSchema() {
    ...
    const schema = {
      ...
      description: "Traditional burial services with visitation, funeral services, and graveside ceremonies. Plan ahead for peace of mind with dignity and respect.",
      provider: {
        "@type": "FuneralHome",
...
</p> <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 lg:gap-8"> <div class="service-card bg-secondary p-4 md:p-6 lg:p-8 rounded-lg shadow-sm border-t-4 border-accent"> <div class="flex items-center gap-2 md:gap-3 mb-3 md:mb-4"> <svg class="w-6 h-6 md:w-8 md:h-8 text-accent flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path> </svg> <h3 class="text-lg md:text-xl lg:text-2xl font-heading font-bold text-primary">
Traditional Farewell
</h3> </div> <p class="text-sm md:text-base text-text leading-relaxed">
...
</p> </div> <div class="service-card bg-secondary p-4 md:p-6 lg:p-8 rounded-lg shadow-sm border-t-4 border-accent"> <div class="flex items-center gap-2 md:gap-3 mb-3 md:mb-4"> <svg class="w-6 h-6 md:w-8 md:h-8 text-accent flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path> </svg> <h3 class="text-lg md:text-xl lg:text-2xl font-heading font-bold text-primary">
Simple Farewell
</h3> </div> <p class="text-sm md:text-base text-text leading-relaxed">
...
</p> </div> <div class="service-card bg-secondary p-4 md:p-6 lg:p-8 rounded-lg shadow-sm border-t-4 border-accent"> <div class="flex items-center gap-2 md:gap-3 mb-3 md:mb-4"> <svg class="w-6 h-6 md:w-8 md:h-8 text-accent flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path> </svg> <h3 class="text-lg md:text-xl lg:text-2xl font-heading font-bold text-primary">
Immediate Burial
</h3> </div> <p class="text-sm md:text-base text-text leading-relaxed">
