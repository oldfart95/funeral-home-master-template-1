...
const $$Veteran = createComponent(($$result, $$props, $$slots) => {
...
</p> </div> </section> ${renderComponent($$result2, "OurStory", $$OurStory, { "language": isSpanish ? "es" : "en" })} ${renderComponent($$result2, "ImmediateNeedBanner", $$ImmediateNeedBanner, { "language": isSpanish ? "es" : "en" })} ${renderComponent($$result2, "ServiceChoicePortal", $$ServiceChoicePortal, { "cremationHeadline": "Veteran Honors", "cremationBody": "Cremation services that recognize and honor military service. We help you access veteran benefits and ensure your service is remembered with the dignity and respect you've earned.", "cremationLink": isSpanish ? "/veteran-cremation-es" : "/veteran-cremation", "burialHeadline": "Traditional Rites", "burialBody": "Burial services with full military honors. We coordinate with the VA to ensure you receive all eligible benefits, including burial allowances, headstones, and cemetery services.", "burialLink": isSpanish ? "/veteran-burial-es" : "/veteran-burial" })}  <section class="py-10 md:py-24 bg-white"> <div class="container mx-auto px-4 sm:px-6 lg:px-8"> <div class="max-w-4xl mx-auto"> <h2 class="text-2xl md:text-4xl font-heading font-bold text-primary mb-6 md:mb-8 text-center">
Veteran Services
...
</h3> ${renderComponent($$result2, "Accordion", $$Accordion, { "language": "en", "items": getFAQs("en", "veteran") })} </div> </div> </div> </section> ${renderComponent($$result2, "OngoingCare", $$OngoingCare, { "language": isSpanish ? "es" : "en" })} ${renderComponent($$result2, "ContactForm", $$ContactForm, { "language": isSpanish ? "es" : "en" })} ` })}`;
}, "C:/Users/User A/Documents/GitHub/funeral-home-landing-site/src/pages/veteran.astro", void 0);

const $$file = "C:/Users/User A/Documents/GitHub/funeral-home-landing-site/src/pages/veteran.astro";
const $$url = "/veteran";
