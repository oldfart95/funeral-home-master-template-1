...
const $$Cremation = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Cremation;
  ...
  function generateServiceSchema() {
    ...
    const schema = {
      ...
      description: "Comprehensive cremation services including direct cremation, memorial services, and full-service options. Plan ahead with dignity and respect.",
      provider: {
        "@type": "FuneralHome",
...
</p> <div class="grid md:grid-cols-3 gap-4 md:gap-8"> <!-- Option 1: Direct Cremation --> <div class="service-card bg-secondary p-4 md:p-6 lg:p-8 rounded-lg shadow-sm border-t-4 border-accent"> <div class="flex items-center gap-3 mb-3 md:mb-4"> <svg class="w-8 h-8 md:w-10 md:h-10 text-accent flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path> </svg> <h3 class="text-lg md:text-2xl font-heading font-bold text-primary">
The Simple Option<br> <span class="text-base md:text-lg font-normal">(Direct Cremation)</span> </h3> </div> <p class="text-sm md:text-base text-text mb-4 md:mb-6 leading-relaxed">
This is the most basic choice. It is for people who want something simple and private.
</p> <ul class="space-y-2 md:space-y-3 text-sm md:text-base text-text"> <li class="flex items-start"> <span class="text-accent mr-2">\u2022</span> <span>Professional transportation and care of the deceased.</span> </li> <li class="flex items-start"> <span class="text-accent mr-2">\u2022</span> <span>The cremation takes place.</span> </li> <li class="flex items-start"> <span class="text-accent mr-2">\u2022</span> <span>There is no public funeral or visitation.</span> </li> <li class="flex items-start"> <span class="text-accent mr-2">\u2022</span> <span>The family receives the ashes to bury, scatter, or keep at home.</span> </li> </ul> </div> <!-- Option 2: Memorial Option --> <div class="service-card bg-secondary p-4 md:p-6 lg:p-8 rounded-lg shadow-sm border-t-4 border-accent"> <div class="flex items-center gap-3 mb-3 md:mb-4"> <svg class="w-8 h-8 md:w-10 md:h-10 text-accent flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path> </svg> <h3 class="text-lg md:text-2xl font-heading font-bold text-primary">
The Memorial Option<br> <span class="text-base md:text-lg font-normal">(Journey of Remembrance)</span> </h3> </div> <p class="text-sm md:text-base text-text mb-4 md:mb-6 leading-relaxed">
This option allows friends and family to say goodbye together.
</p> <ul class="space-y-2 md:space-y-3 text-sm md:text-base text-text"> <li class="flex items-start"> <span class="text-accent mr-2">\u2022</span> <span>Includes a time for family and friends to visit.</span> </li> <li class="flex items-start"> <span class="text-accent mr-2">\u2022</span> <span>Includes a memorial service to share memories.</span> </li> <li class="flex items-start"> <span class="text-accent mr-2">\u2022</span> <span>The cremation happens, and the ashes are returned to the family.</span> </li> </ul> </div> <!-- Option 3: Full Service Option --> <div class="service-card bg-secondary p-4 md:p-6 lg:p-8 rounded-lg shadow-sm border-t-4 border-accent"> <div class="flex items-center gap-3 mb-3 md:mb-4"> <svg class="w-8 h-8 md:w-10 md:h-10 text-accent flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path> </svg> <h3 class="text-lg md:text-2xl font-heading font-bold text-primary">
The Full Service Option<br> <span class="text-base md:text-lg font-normal">(Journey of Life)</span> </h3> </div> <p class="text-sm md:text-base text-text mb-4 md:mb-6 leading-relaxed">
This is like a traditional funeral, but it ends with cremation instead of burial.
</p> <ul class="space-y-2 md:space-y-3 text-sm md:text-base text-text"> <li class="flex items-start"> <span class="text-accent mr-2">\u2022</span> <span>Your body is prepared so family and friends can visit and say goodbye.</span> </li> <li class="flex items-start"> <span class="text-accent mr-2">\u2022</span> <span>A special "rental casket" is used for the service.</span> </li> <li class="flex items-start"> <span class="text-accent mr-2">\u2022</span> <span>After the funeral service is over, the cremation takes place.</span> </li> </ul> </div> </div> </div> </div> </section>  <section class="py-10 md:py-24 bg-secondary"> <div class="container mx-auto px-4 sm:px-6 lg:px-8"> <div class="max-w-4xl mx-auto"> <h2 class="text-2xl md:text-4xl font-heading font-bold text-primary mb-6 md:mb-8 text-center">
