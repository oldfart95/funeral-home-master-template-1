...
const $$VeteranBurial = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$VeteranBurial;
  ...
  function generateServiceSchema() {
    ...
    const schema = {
      ...
      "@type": "Service",
      name: "Veteran Burial Services",
      description: "Veteran burial services with full military honors. We coordinate with the VA to ensure you receive all eligible benefits including burial allowances and headstones.",
      provider: {
        "@type": "FuneralHome",
...
</p> </div> </div> </div> </section>  <section class="py-10 md:py-24 bg-white"> <div class="container mx-auto px-4 sm:px-6 lg:px-8"> <div class="max-w-4xl mx-auto"> <h2 class="text-2xl md:text-4xl font-heading font-bold text-primary mb-6 md:mb-12 text-center">
Common Questions About Veteran Services
</h2> <div class="space-y-4 md:space-y-6"> <div class="bg-secondary p-4 md:p-6 rounded-lg"> <h3 class="text-lg md:text-xl font-heading font-semibold text-primary mb-2 md:mb-3">
What benefits are available for veterans?
</h3> <p class="text-sm md:text-base text-text leading-relaxed">
Veterans and their families may be eligible for various benefits including burial allowances, headstones, and cemetery services.
</p> </div> </div> </div> </div> </section>  <section class="py-10 md:py-24 bg-secondary"> <div class="container mx-auto px-4 sm:px-6 lg:px-8"> <div class="max-w-4xl mx-auto"> <h2 class="text-2xl md:text-4xl font-heading font-bold text-primary mb-6 md:mb-8 text-center">
Planning & FAQ
