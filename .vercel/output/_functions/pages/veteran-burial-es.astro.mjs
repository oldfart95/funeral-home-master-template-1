...
const $$VeteranBurialEs = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$VeteranBurialEs;
  ...
  function generateServiceSchema() {
    ...
    const schema = {
      ...
      "@type": "Service",
      name: "Servicios de Entierro para Veteranos",
      description: "Servicios de entierro para veteranos con honores militares completos. Coordinamos con la VA para asegurar que reciba todos los beneficios elegibles incluyendo asignaciones de entierro y l\xE1pidas.",
      provider: {
        "@type": "FuneralHome",
