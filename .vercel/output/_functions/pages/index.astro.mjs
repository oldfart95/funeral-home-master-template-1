...
</p> </div> </section> ${renderComponent($$result2, "OurStory", $$OurStory, { "language": isSpanish ? "es" : "en" })} ${renderComponent($$result2, "ImmediateNeedBanner", $$ImmediateNeedBanner, { "language": isSpanish ? "es" : "en" })} ${renderComponent($$result2, "ServiceChoicePortal", $$ServiceChoicePortal, { "cremationHeadline": "Cremation Services", "cremationBody": "A modern approach to tradition, offering flexibility and personalized remembrance. Choose from direct cremation, memorial services, or full-service options that honor your loved one's memory.", "cremationLink": isSpanish ? "/cremation-es" : "/cremation", "burialHeadline": "Traditional Burial", "burialBody": "Honoring the timeless dignity of a final resting place with grace and reverence. We offer traditional farewells, simple services, graveside ceremonies, and immediate burial options.", "burialLink": isSpanish ? "/burial-es" : "/burial" })}  <section class="py-10 md:py-24 bg-secondary"> <div class="container mx-auto px-4 sm:px-6 lg:px-8"> <div class="max-w-4xl mx-auto"> <h2 class="text-2xl md:text-4xl font-heading font-bold text-primary mb-6 md:mb-8 text-center">
Planning & FAQ
...
</h3> ${renderComponent($$result2, "Accordion", $$Accordion, { "language": "en", "items": getFAQs("en", "general") })} </div> </div> </div> </section>  <section class="py-10 md:py-24 bg-secondary"> <div class="container mx-auto px-4 sm:px-6 lg:px-8"> <div class="max-w-4xl mx-auto"> <div class="bg-white p-5 md:p-12 rounded-lg shadow-sm border-t-4 border-accent"> <h2 class="text-xl md:text-3xl font-heading font-bold text-primary mb-4 md:mb-6">
...
}, "C:/Users/User A/Documents/GitHub/funeral-home-landing-site/src/pages/index.astro", void 0);

const $$file = "C:/Users/User A/Documents/GitHub/funeral-home-landing-site/src/pages/index.astro";
const $$url = "";
